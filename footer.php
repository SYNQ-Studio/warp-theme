...
// Check if Elementor footer is set
		...
		<div class="footer-bottom">
			<div class="footer-container">
				<div class="footer-bottom-inner">
					<div class="site-info">
						<?php
						$copyright_text = get_theme_mod( 'warp_copyright_text', '' );
						if ( ! empty( $copyright_text ) ) {
							...
							<span class="copyright">
								...
								printf(
									...
									esc_html__( 'Powered by %1$s and %2$s', 'warp-theme' ),
									'<a href="' . esc_url( __( 'https://github.com/SYNQ-Studio/warp-theme', 'warp-theme' ) ) . '">Warp Theme</a>',
									'<a href="' . esc_url( __( 'https://wordpress.org/', 'warp-theme' ) ) . '">WordPress</a>'
								);
								?>
							</span>
							<?php
					...
					<?php if ( has_nav_menu( 'footer' ) ) : ?>
						<nav class="footer-navigation" aria-label="<?php esc_attr_e( 'Footer Navigation', 'warp-theme' ); ?>">
							<?php
							wp_nav_menu(
								array(
					...
					<div class="social-links">
						...
						foreach ( $social_links as $key => $data ) {
							$url = get_theme_mod( 'warp_social_' . $key, '' );
							if ( ! empty( $url ) ) {
								printf(
